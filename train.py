...
#root_dir = os.path.abspath('../../PycharmProjects/Phase1')
root_dir = os.path.abspath('/home/devcula/vscode-workspace/Viola-Jones/')
...
for img_name in train.filename:
    ...
    features.calc_features(img_scaled)
...
for img_name in test.filename:
    image_path = os.path.join(data_dir, 'Train', 'Images', 'test','test-images', img_name)
    img = imread(image_path, flatten=True)
    #img = img.astype('float32')
    #Adding Code
    img = np.array(img)
