...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__features

#else
#  define SWIG_init    init_features

#endif
#define SWIG_name    "_features"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_calc_features(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:calc_features",&obj0)) SWIG_fail;
  {
    npy_intp size[2] = {
      -1, -1 
    };
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"calc_features", _wrap_calc_features, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
